/**********************************************************************
map_feed.parse.csv.js

$Comment: provides JavaScript to import 'csv' feeds
$Source : map_feed.parse.csv.js,v $

$InitialAuthor: guenter richter $
$InitialDate: 2014/02/06 $
$Author: guenter richter $
$Id: map_feed.parse.csv.js 1 2014-02-06 10:30:35Z Guenter Richter $

Copyright (c) Guenter Richter
$Log:map_feed.parse.csv,v $
**********************************************************************/

/** 
 * @fileoverview This file is a geojson plugin for ixmaps.feed to import georeferenced data in CSV
 *
 ...
 */
	ixmaps.feed.parse.csv = function(data,opt){
