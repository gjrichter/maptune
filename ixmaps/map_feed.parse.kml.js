...
/**
 * depracated !!! use ixmaps.feed.parse.kml_json instead !!!
 *
 ...
 * @return an ixmaps layer object
 */
	ixmaps.feed.parse.kml = function(data,opt){
		...
		if ( !$.xml2json ){
			...
			.fail(function(jqxhr, settings, exception) {
			  ixmaps.errorMessage("'"+opt.type+"' can't load xml2json !",2000);
			});
