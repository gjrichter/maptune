/**********************************************************************
map_feed.parse.Koeln_Parken.js

$Comment: provides JavaScript for import of feeds
$Source : map_feed.parse.Koeln_Parken.js,v $
...
$Log:map_feed.parse.Koeln_Parken,v $
**********************************************************************/
 ...
 */
	ixmaps.feed.parse.Koeln_Parken = function(data,opt){
		...
		if ( opt.format == "json" ) {
			...
			// ----------------------
			var layerset = new ixmaps.feed.LayerSet(szName);
