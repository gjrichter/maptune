...
function _mapapi_initialize_all(szMapDiv,szItemlistDiv,szLegendDiv,szDirectionsDiv,szMapService){
	...
	// ----------------------------------------------
	setTimeout("maptune.jsapi.reset()",100);
...
maptune.message = function(szMessage,fFlag,code){console.log(szMessage);
	...
	_TRACE("loading:"+maptune.messageCount+","+fFlag+','+code);
...
maptune.errorMessage = function(szMessage,nTimeout){console.log(szMessage);
...
maptune.confirmMessage = function(szMessage,callback){console.log(szMessage);
...
maptune.displayMessage = function(szMessage,callback){
...
maptune.infoMessage = function(szMessage,callback){
...
maptune.jsapi.getHashFeed = function() {
	...
	if ( maptune.jsapi.szBookmark ){
		_TRACE("get bookmark: "+maptune.jsapi.szBookmark);
...
maptune.jsapi.playLayer = function(szName){
