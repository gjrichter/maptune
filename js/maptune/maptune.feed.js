...
(function() {
	...
	scriptsAry.push('<script type="text/javascript" src="' + scriptBase + 'maptune.feed.FusionTables.js"></script>');
	scriptsAry.push('<script type="text/javascript" src="' + scriptBase + 'maptune.feed.query.FusionTables.js"></script>');
