		...
		if ( (this.lastSource != layer.source) ){
			...
			var szHTML = "";
				if ( layer.sourcelegend == "collapsed" ){
					...
					szHTML += szName;
					szHTML += "</a>";
					//szHTML += "<a href=\"javascript:maptune.jsapi.removeData('"+layer.source+"')\"><img src='resources/ui/delete.png' height='22' style=\"opacity:0.3;float:right;margin-right:11px;margin-top:5px\" /></a>";
...
_mapup_get_collected_items = function(count){
	...
	if ( collection && (typeof(collection) == "object") ){
		...
		maptune.infoMessage("error in collection");
	}
};
...
function _mapup_getIcon(map,defaultIcon,layer,markers,i,szFlag) {	
		...
		if (1){
		try	{
			var userIcon = maptune.jsapi.onGetIcon(icon,markers[i],i);
			if ( userIcon )	{
				return userIcon;
			}
		}
...
Timeline.prototype.next = function() {
	...
	if ( this.play ){
		...
		setTimeout("maptune.timeline.next();",150);
	}else{
